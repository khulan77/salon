...
/**
 * Гар утсанд — хажуу тийш гүйлгэх, зогсоц бүхий (snap) мөр. Дэлгэц томрох үед
 * энгийн grid болно. Ингэснээр утсан дээр урт жагсаалт болж сунахгүй, эхний
 * дэлгэцэнд хэд хэдэн карт "цухуйж" харагдана.
 */
